...
void main() {
  ...
  test('Test Filtered and cloned ', () async {
    ...
    mccf = mc.applyFilter("a111", true, (match, toLowerCase, node) {
    ...
    var mcff = mc.applyFilter("b21", true, (match, toLowerCase, node) {
    ...
    mcff = mc.applyFilter("A112", true, (match, toLowerCase, node) {
      return node.pathKey.toLowerCase().contains(match);
    },);
    toStrTest(mcff, "A(1)R A.A1(2)R A.A1.A11(3)R A.A1.A11.A112(4)LR");
    toStrTest(m, expectFull);

    mcff = mc.applyFilter("C", true, (match, toLowerCase, node) {
      return node.pathKey.toLowerCase().contains(match);
    },);
    ...
    mcff = mc.applyFilter("C", false, (match, toLowerCase, node) {
      return node.pathKey.toLowerCase().contains(match);
    },);
    toStrTest(mcff, "");
